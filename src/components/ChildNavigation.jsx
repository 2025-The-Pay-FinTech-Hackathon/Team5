...
function ChildNavigation({ user, onLogout }) {
  ...
  return (
    <AppBar position="fixed" sx={{ height: 64, borderRadius: 0, boxShadow: 2, bgcolor: '#FFD600', color: '#222' }}>
      <Toolbar
        sx={{
          display: 'flex',
